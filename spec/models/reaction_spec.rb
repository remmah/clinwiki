...
RSpec.describe Reaction, type: :model do
  ...
  describe "reaction requires nct_id, user_id, and reaction_type" do
    ...
    it "creation of reaction requires multiple attributes to be defined" do
      ...
      expect(reaction.errors.messages).to have_key(:reaction_type_id)
    end

  end
  describe "reaction with nct_id, user_id, and reaction_type" do
    let(:reaction) { Reaction.new(nct_id:"123",user_id:1, reaction_type_id: 1) }
    it "creation of reaction requires multiple attributes to be defined" do
      expect(reaction.save).to be false
